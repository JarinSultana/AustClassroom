...
public class IumsActivity extends AppCompatActivity {
        ...
        TextOutsideCircleButton.Builder builder = new TextOutsideCircleButton.Builder()
                ...
                .listener(new OnBMClickListener() {
                    ...
                    public void onBoomButtonClick(int index) {
                        ...
                        if (index == 0) {
                            if (haveNetwork()) {
                                Intent home = new Intent(IumsActivity.this, HomeActivity2.class);
                                startActivity(home);
                                finish();
                            }
                            else if (!haveNetwork()){
                                Toast.makeText(IumsActivity.this, "Network connection unavailable!!\nCheck your 'internet' connection and try again", Toast.LENGTH_LONG).show();
                            }
                        }
                        if (index == 1) {
                            if (haveNetwork()) {
                                Intent profile = new Intent(IumsActivity.this, UserProfileActivity.class);
                        ...
                        if (index == 2) {
                            Toast.makeText(IumsActivity.this, "Settings will open", Toast.LENGTH_LONG).show();
                        }
                        if (index == 3) {
                            if (haveNetwork()) {
                                firebaseAuth.signOut();
                                finish();
                                startActivity(new Intent(IumsActivity.this, LoginActivity.class));
                            }
                            else if (!haveNetwork()){
                                Toast.makeText(IumsActivity.this, "Network connection unavailable!!\nCheck your 'internet' connection and try again", Toast.LENGTH_LONG).show();
                            }
